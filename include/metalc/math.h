...
METALC_EXPORT_ASM float mclib_sinf(float x);
METALC_EXPORT_ASM double mclib_tan(double x);
METALC_EXPORT_ASM float mclib_tanf(float x);
METALC_EXPORT_ASM double mclib_pow(double base, double exponent);
METALC_EXPORT_ASM float mclib_powf(float base, float exponent);
METALC_EXPORT_ASM double mclib_fabs(double x);
METALC_EXPORT_ASM float mclib_fabsf(float x);
METALC_EXPORT_ASM double mclib_asin(double x);
METALC_EXPORT_ASM float mclib_asinf(float x);
METALC_EXPORT_ASM double mclib_acos(double x);
