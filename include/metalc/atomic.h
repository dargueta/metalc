...
METALC_EXPORT METALC_ATTR__NONNULL void atomic_store_8(atomic_object_t *object,
                                                       uint8_t value);
METALC_EXPORT METALC_ATTR__NONNULL void atomic_store_16(atomic_object_t *object,
                                                        uint16_t value);
METALC_EXPORT METALC_ATTR__NONNULL void atomic_store_32(atomic_object_t *object,
                                                        uint32_t value);
METALC_EXPORT METALC_ATTR__NONNULL void atomic_store_64(atomic_object_t *object,
                                                        uint64_t value);
METALC_EXPORT METALC_ATTR__NONNULL uint8_t atomic_exchange_8(atomic_object_t *object,
                                                             uint8_t value);
METALC_EXPORT METALC_ATTR__NONNULL uint16_t atomic_exchange_16(atomic_object_t *object,
                                                               uint16_t value);
METALC_EXPORT METALC_ATTR__NONNULL uint32_t atomic_exchange_32(atomic_object_t *object,
                                                               uint32_t value);
METALC_EXPORT METALC_ATTR__NONNULL uint64_t atomic_exchange_64(atomic_object_t *object,
                                                               uint64_t value);
